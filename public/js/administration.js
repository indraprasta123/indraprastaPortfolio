...
lihatBtn.addEventListener("click", () => {
  ...
  if (!pdfContainer.classList.contains("hidden")) {
    lihatBtn.innerHTML = '<i class="fa fa-times"></i> Experience Letter';
  } else {
    lihatBtn.innerHTML = '<i class="fa fa-eye"></i> Experience Letter';
  }
});
...
const translations = {
  id: {
    ...
    "txt-59":
      "Staf Administrasi – CV Wibawa Putra Utamajaya (Purworejo | 11 Juli 2020 – 16 November 2023)",
    "txt-60":
      "Bertanggung jawab untuk mengelola administrasi operasional perusahaan, khususnya yang berkaitan dengan pencatatan data, manajemen stok, dan pelaporan keuangan.",
    "txt-61":
      "Membuat dan mengelola surat pengiriman untuk barang yang akan dikirim.",
    "txt-62":
      "Mencatat transaksi penjualan dan pergerakan persediaan menggunakan SISKA (Sistem Informasi Akuntansi).",
    "txt-63":
      "Melakukan rekapitulasi stok gudang dan pengecekan stok fisik secara berkala.",
    "txt-64":
      "Memproses dan menghitung pendapatan penjualan serta data keuangan menggunakan Microsoft Excel.",
    "txt-65":
      "Menyusun laporan keuangan yang mencakup pendapatan dan pengeluaran dari aktivitas penjualan.",
    "txt-66":
      "Memastikan data administratif akurat, terorganisir, dan mudah diakses.",
    "txt-67":
      "Saya memiliki kompetensi administrasi yang mencakup pengelolaan data, dokumentasi, dan dukungan operasional perusahaan.",
    "txt-68":
      "Pengarsipan dan penyimpanan dokumen, manajemen administrasi, serta pencatatan dokumen secara rapi dan terstruktur.",
    "administration.": "ADMINISTRASI",
    "txt-69":
      "Pembukuan dasar, pengolahan data penjualan, laporan keuangan (pendapatan & pengeluaran), serta manajemen stok dan faktur.",
    "accounting.": "AKUTANSI",
    "txt-70":
      "Microsoft Excel (entri data, rumus, rekap), Microsoft Word, sistem SISKA, serta pengoperasian komputer dan aplikasi perkantoran.",
  ...
  en: {
    ...
    "txt-59":
      "Administrative Staff – CV Wibawa Putra Utamajaya (Purworejo | July 11, 2020 – November 16, 2023)",
    "txt-60":
      "Responsible for managing the company’s operational administration, particularly related to data recording, stock management, and financial reporting.",
    "txt-61": "Created and managed delivery notes for outgoing goods.",
    "txt-62":
      "Recorded sales transactions and inventory movement using SISKA (Accounting Information System).",
    "txt-63":
      "Conducted warehouse stock recaps and regular physical stock checks.",
    "txt-64":
      "Processed and calculated sales revenue and financial data using Microsoft Excel.",
    "txt-65":
      "Prepared financial reports covering income and expenses from sales activities.",
    "txt-66":
      "Ensured administrative data was accurate, organized, and easy to access.",
    "txt-67":
      "I have administrative competencies that include data management, documentation, and company operational support.",
    "txt-68":
      "Archiving and storing documents, administrative management, and recording documents in a neat and structured manner.",
    "administration.": "ADMINISTRATION",
    "txt-69":
      "Basic bookkeeping, sales data processing, financial reports (income & expenses), as well as stock and invoice management.s",
    "accounting.": "ACCOUNTING",
    "teknikal/software.": "TECHNICAL/SOFTWARE",
    "txt-70":
      "Microsoft Excel (data entry, formulas, recaps), Microsoft Word, SISKA system, as well as computer operation and office applications.",
...
//caraousel SKILLS administration
$(".skills__content__slider1").slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  dots: true,
});
